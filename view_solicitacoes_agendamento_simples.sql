-- View simplificada para solicitações de agendamento
...
SELECT 
  ...
  -- Endereço simples (apenas nome da unidade por enquanto)
  un.nome as endereco_completo_unidade,
...
-- Função simplificada para buscar solicitações pendentes
